...
const Footer = () => (
  <footer
    id="footer"
    className="w-full border-t border-neutral-800 py-6 px-4 md:px-12 bg-black text-neutral-400 text-xs flex flex-col md:flex-row md:items-end justify-between gap-2 mt-16"
  >
    <div className="flex flex-row items-center gap-2 mb-4 md:mb-0">
      ...
      <span className="hidden md:inline">·</span>
      <span>
        Handcrafted with <FaHeart className="text-red-900 inline" />.
      </span>
    </div>
    <div className="flex flex-col items-start gap-8 text-left w-full md:w-[32%]">
      <p className="text-xs md:text-sm text-neutral-400 max-w-xs mb-2">
        Hi, I&apos;m Hirusha — a software engineer focused on cloud
        infrastructure, full-stack product development, and AI-integrated
        tooling. Let&apos;s connect.
      </p>
